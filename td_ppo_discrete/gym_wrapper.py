...
class GymWrapper(gym.Env):
    ...
    def step(self, action):
        ...
        #         print("max step")
        #         return self._obs_to_np_array(obs), reward, self.game.game_over, 0, 1, self.game.the_plot
        #     elif self.game.game_over and self.game.the_plot['terminal_reason'] == 'terminal_state':
        #         print("terminal state return")
        #         return self._obs_to_np_array(obs), reward, self.game.game_over, 0, 1, self.game.the_plot
        # else:
        #     return self._obs_to_np_array(obs), reward, self.game.game_over, 0, 0, self.game.the_plot
...
class VecEnv:
    ...
    def step(self, actions):
        ...
        #return np.stack(obs_list, axis=0), rew_list, done_list, dw_list, do_list, info_list

...
def main(args, env_name, number, seed):
    env = VecEnv(env_name)
    env_evaluate = VecEnv(env_name)  # When evaluating the policy, we need to rebuild an environment
    # Set random seed
    env.seed(seed)
...
if __name__ == '__main__':
    ...
    env_name = ['randomized_v2', 'LunarLander-v2']
    env_index = 1
    main(args, env_name=env_name[0], number=1, seed=0)

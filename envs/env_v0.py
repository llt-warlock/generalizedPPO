...
WAREHOUSE_FG_COLOURS = {' ': (870, 838, 678),  # Floor. 有
                        '#': (428, 135, 0),    # Walls.   有         used
                        'C': (0, 600, 67),     # Citizen.   有
                        'x': (850, 603, 270),  # Unused.
                        'P': (388, 400, 999),  # The player. used 有
                        'F': (300, 300, 300),  # Waste.
                        'G': (900, 300, 900),      # Goal.  extinguisher.有
                        'H': (428, 135, 0)}    # House.    没见到
...
class CitizenDrape(plab_things.Drape):
    ...
    def update(self, actions, board, layers, backdrop, things, the_plot):
        ...
        if the_plot.frame == 0:
            ...
            print("bbb ", random_positions[-1], "   ", scalar_to_idx(random_positions[-1]))
            ...
            print("the_plot P : ", the_plot['P_pos'])
            print("the_plot H : ", the_plot['H_pos'])

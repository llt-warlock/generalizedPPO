...
PREFERENCE = {'9':[1,0], '10':[0.8, 0.2], '11':[0.6, 0.4], '12':[0.4, 0.6], '13':[0.2, 0.8], '14':[0, 1],
              '17':[1,0], '18':[0.8, 0.2], '19':[0.6, 0.4], '20':[0.4, 0.6], '21':[0.2, 0.8], '22':[0, 1],
              '25':[1,0], '26':[0.8, 0.2], '27':[0.6, 0.4], '28':[0.4, 0.6], '29':[0.2, 0.8], '30':[0, 1],
              '33':[1,0], '34':[0.8, 0.2], '35':[0.6, 0.4], '36':[0.4, 0.6], '37':[0.2, 0.8], '38':[0, 1],
              '41':[1,0], '42':[0.8, 0.2], '43':[0.6, 0.4], '44':[0.4, 0.6], '45':[0.2, 0.8], '46':[0, 1],
              '49':[1,0], '50':[0.8, 0.2], '51':[0.6, 0.4], '52':[0.4, 0.6], '53':[0.2, 0.8], '54':[0, 1]}
